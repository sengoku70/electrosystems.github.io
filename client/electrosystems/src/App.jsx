...
function App() {
  ...
  return (
    <>
      <Router>
        <nav className="navigation px-6 h-[100px] flex row items-center fixed w-8/10 z-30 bg-white/40 shadow-2xl mx-50 mt-2 backdrop-blur-[5px] font-[Science gothic] text-[25px] flex gap-2">
